...
import 'package:test_calendar/components/calendar/src/controller/day_view.dart';
import 'package:test_calendar/components/calendar/src/event.dart';
import 'package:test_calendar/components/calendar/src/styles/day_bar.dart';
import 'package:test_calendar/components/calendar/src/styles/day_view.dart';
import 'package:test_calendar/components/calendar/src/styles/hours_column.dart';
import 'package:test_calendar/components/calendar/src/utils/builders.dart';
import 'package:test_calendar/components/calendar/src/utils/event_grid.dart';
import 'package:test_calendar/components/calendar/src/utils/hour_minute.dart';
import 'package:test_calendar/components/calendar/src/utils/scroll.dart';
import 'package:test_calendar/components/calendar/src/utils/utils.dart';
import 'package:test_calendar/components/calendar/src/widgets/day_bar.dart';
import 'package:test_calendar/components/calendar/src/widgets/hours_column.dart';
...
class DayView extends ZoomableHeadersWidget<DayViewStyle, DayViewController> {
  ...
  DayView(
      ...
      OnchangeDateCallback? onChangeDate})
      : events = events ?? [],
